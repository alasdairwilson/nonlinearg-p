...
!----------------------------------------------------------
      ...
      Include 'nonling.inc'
      double precision vvt(1:5,0:lt+1,0:mt+1)
...
!           tt(1,0,m)=1.d0+damp*1.d0*zterm*xterm
          vv(2,0,0,m)=damp*1.d0*zterm*xterm
          vv(2,1,0,m)=damp*1.d0*zterm*xterm
          vv(2,2,0,m)=damp*1.d0*zterm*xterm
 
       
          uu(2,0,0,m)=damp*1.d0*zterm*xterm
          uu(2,1,0,m)=damp*1.d0*zterm*xterm
          uu(2,2,0,m)=damp*1.d0*zterm*xterm
