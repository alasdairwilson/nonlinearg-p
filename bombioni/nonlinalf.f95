...
!-----------------------------------------------------------------------------------------------------------
elseif(experiment.eq.'spbombp') then
...
elseif(experiment.eq.'spbombb') then
...
!This routine writes out the current uu and vv values
      ...
      write(21,*)'# timestep = ',n
      do l=200,400
       write(21,100)((uu(1,0,l,m)-1.0d0),',',m=200,400)
      end do
      write(21,*)
      write(21,*)
      ...
      write(24,*)'# timestep = ',n
      do l=200,400
      write(24,100)(ptot(l,m),',',m=200,400)
      end do
      write(24,*)
      write(24,*)
      ...
      write(25,*)'# timestep = ',n
      do l=200,400
      write(25,100)((uu(5,0,l,m)-gamma*1.0d0),',',m=200,400)
      end do
      write(25,*)
      write(25,*)
      ...
      write(33,*)'# timestep = ',n
      do l=200,400
      write(33,100)((vv(5,0,l,m)-gamma*1.0d0),',',m=200,400)
      end do
      write(33,*)
      write(33,*)
