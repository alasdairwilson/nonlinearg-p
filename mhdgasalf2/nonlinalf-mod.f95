...
! 
	...
	timing_difference=finish-start
	time_display=(60*dble(timing_difference(6))&
	+dble(timing_difference(7))+dble(timing_difference(8))/1000)
	print '("Time = ",f9.4," seconds. Remaining:",f9.1," h",f4.0," m")',time_display,&
	(time_display/20*(nt-n)/60/60)
